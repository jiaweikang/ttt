...
- (void)setText:(NSAttributedString*)text animated:(BOOL)animated
{
    NSUInteger nextLabelIndex = [self nextLabelIndex];
    YYLabel* nextLabel = [_labels objectAtIndex:nextLabelIndex];
    YYLabel* previousLabel = _currentLabel;
...
- (void)prepareTransitionBlocks
{
    ...
    self.preTransitionBlock = ^(YYLabel* labelToEnter) {
    ...
    self.transitionBlock = ^(YYLabel* labelToExit, YYLabel* labelToEnter) {
