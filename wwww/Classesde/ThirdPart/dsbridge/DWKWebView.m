...
-(instancetype)initWithFrame:(CGRect)frame configuration:(WKWebViewConfiguration *)configuration
{
    ...
    isDebug=false;
    dialogTextDic=@{};
    NSString * js=[@"window._dswk=true;" stringByAppendingString: INIT_SCRIPT];
