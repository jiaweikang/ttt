...
- (void)setImageFilter:(NSString *)imageName {
    ...
    if ([imageName hasPrefix:@"http"]) {
        [self.mImageView yy_setImageWithURL:[NSURL URLWithString:imageName] placeholder:nil];
    }
    else {
        [self.mImageView setImage:[UIImage bundleImageNamed:imageName]];
    }
}
