...
- (void)initialize
{
    ...
    NSLayoutConstraint * widthLayout = [NSLayoutConstraint constraintWithItem:self.placeholderLabel
    ...
    //加约束优先级 避免报警告
    widthLayout.priority=999;
    [self addConstraint:widthLayout];
    NSLayoutConstraint * heightLayout = [NSLayoutConstraint constraintWithItem:self.placeholderLabel
