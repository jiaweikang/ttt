...
+ (void)saveDate:(NSDate *)date Forkey:(NSString*) key{
    [[NSUserDefaults standardUserDefaults]setObject:date forKey:[NSString stringWithFormat:@"%@_%@",[US_UserUtility sharedLogin].m_userId,key]];
    [[NSUserDefaults standardUserDefaults] synchronize];
}

+ (NSDate *)getDateForkey:(NSString *)key{
    NSDate *date = [[NSUserDefaults standardUserDefaults] valueForKey:[NSString stringWithFormat:@"%@_%@",[US_UserUtility sharedLogin].m_userId,key]];
    return date;
}

+ (BOOL)todayHadRequestForKey:(NSString *)key{
    BOOL hasReuest=NO;
    NSDate *latestDate = [[NSUserDefaults standardUserDefaults]objectForKey:[NSString stringWithFormat:@"%@_%@",[US_UserUtility sharedLogin].m_userId,key]];
